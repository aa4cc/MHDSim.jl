...
## Usage
For usage instructions, please refer the `examples/example.jl` file, which contains a simple example of how to set up and run the simulation.
...
\mathbf{B}(t, \mathbf{r}) = \sum_{j=1}^{n_\mathrm{em}} \psi_j(t) \mathbf{B}_j(\mathbf{r}),
$$
...
For more details, see the Master's thesis of Adam Uchytil: [Feedback Control of Magnetohydrodynamic Flow Using Data-Driven Methods](https://dspace.cvut.cz/handle/10467/114979)
